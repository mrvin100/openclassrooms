export function ajoutListenerAvis(){
    const pieceElements = document.querySelectorAll('.fiches article button');

    for(let i = 0; i < pieceElements.length; i++){
        pieceElements[i].addEventListener('click', async function (event){
...
export function ajoutListenerEnvoyerAvis(){
    ...
    formulaireAvis.addEventListener('submit', function(event){
        //Deactivation du comportement par defaut du navigateur
